    ...
    >
      <div className="flex items-center justify-center w-full px-4">
        ...
        <div className="flex space-x-4">
          <a
            className="px-3 py-2 text-lg font-medium text-white hover:text-green-400 cursor-pointer"
            onClick={() => scrollToSection('home')}
          >
            Home
          </a>
          <a
            className="px-3 py-2 text-lg font-medium text-white hover:text-customColor cursor-pointer"
